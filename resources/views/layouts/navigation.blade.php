<nav class="main-header navbar navbar-expand navbar-light-primary elevation-4" style="background: #419CFF">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link"style="color: #ffff" data-toggle="dropdown" href="#">
